...
print(f"Funcion de transferencia del controlador PI: {PID}")
...
plt.plot(t,Vsu3,'--',linewidth=3,color = clr4,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu3,':',color = clr5,label='PI(t)') #Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize=11)
plt.ylabel('Vi(t)[V]',fontsize=11)
...
plt.plot(t,Vsu4,'--',linewidth=3,color = clr4,label='Vs(t)') #Respuesta en lazo abierto
plt.plot(t,PIDu4,':',color = clr5,label='PI(t)') #Respuesta en lazo cerrado
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
